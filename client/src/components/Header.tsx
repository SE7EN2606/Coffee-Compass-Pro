      ...
      <div className="container mx-auto px-4 py-3">
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center space-x-4">
            <Link href="/favorites">
              <a className={`flex items-center text-[#E8DCCA] hover:text-white transition ${location === '/favorites' ? 'text-white' : ''}`}>
                <svg 
                  xmlns="http://www.w3.org/2000/svg" 
                  viewBox="0 0 24 24" 
            ...
            <button className="flex items-center text-[#E8DCCA] hover:text-white transition">
              <svg 
                xmlns="http://www.w3.org/2000/svg" 
                viewBox="0 0 24 24" 
                fill="none" 
